...
namespace DidiFrame.Translations.UserCommands.Loader.EmbededCommands.Help
{
	internal class HelpCommandLoaderLoc : SmartDidiFrameLocalizationProvider<HelpCommandLoader>
	{
		public HelpCommandLoaderLoc()
		{
			...
			{
				add.AddTranslation("ArgumentInfoTitle", "Аргумент \"{0}\"");
				add.AddTranslation("CmdDescription", "{0}");
				add.AddTranslation("CmdTitle_1", "Информация о команде {0}");
				add.AddTranslation("CmdTitle_2", "Информация о команде {0} ({1})");
				add.AddTranslation("ExecutionGroupContent_1", "Эта команда может быть запущена {0}");
				add.AddTranslation("ExecutionGroupContent_2", "Эта команда может быть запущена {0} (1)");
				add.AddTranslation("ExecutionGroupTitle", "Группа исполнителей");
				add.AddTranslation("HelpCommandName", "{0}");
				add.AddTranslation("HelpDescription", "Список доступных команд на сервере");
				...
				add.AddTranslation("RemarkContent_1", "Примечание: {0}");
				add.AddTranslation("RemarkContent_2", "Примечание для {0}: {1}");
			...
			{
				add.AddTranslation("ArgumentInfoTitle", "Argument \"{0}\"");
				add.AddTranslation("CmdDescription", "{0}");
				add.AddTranslation("CmdTitle_1", "Information about {0} command");
				add.AddTranslation("CmdTitle_2", "Information about {0} command ({1})");
				add.AddTranslation("ExecutionGroupContent_1", "This command can be runned by {0}");
				add.AddTranslation("ExecutionGroupContent_2", "This command can be runned by {0} (1)");
				add.AddTranslation("ExecutionGroupTitle", "Execution group");
				add.AddTranslation("HelpCommandName", "{0}");
				add.AddTranslation("HelpDescription", "List of available commands on this server");
				...
				add.AddTranslation("RemarkContent_1", "Remark: {0}");
				add.AddTranslation("RemarkContent_2", "Remark for {0}: {1}");
