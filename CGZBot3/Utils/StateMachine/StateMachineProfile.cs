...
{
	internal record StateMachineProfile<TState>(IReadOnlyList<IStateTransitWorker<TState>> StateWorkers, IReadOnlyCollection<StateChangedEventHandler<TState>> StateChangedHandlers) where TState : struct
	{
